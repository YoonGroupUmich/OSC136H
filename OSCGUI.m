       ...
       function DetectBoard(this)
        ...
        function CreatePipePanel(this)           
            ...
            intro_string = {'Custom waveform will assign a series of pre-defined amplitudes on each of the sampling time when it is triggered.',' ',...
                ...
                'Step 2: Input a .pipe file 4, which contains one number to represent the amplitude [0 - 1023] for each sampling. The number of lines in .pipe will reflect the full period of the custom waveform. The .pipe file can be generated by write2file.m',...
